...
func TestCaroselloChangePageNextFromDown(t *testing.T) {
	...
	*posBlock:2,updateCallCallBack,pos2
	posBlock:0,sleepCallCallBack,pos0
	posBlock:1,sleepCallCallBack,pos1
	posBlock:2,sleepCallCallBack,pos2
	posBlock:0,wakeUpCallBack,pos0
	-----------------
	posBlock:0,sleepCallCallBack,pos0
	posBlock:1,sleepCallCallBack,pos1
	posBlock:2,sleepCallCallBack,pos2
	posBlock:1,wakeUpCallBack,pos1
	posBlock:0,sleepCallCallBack,pos0
	posBlock:1,sleepCallCallBack,pos1
	posBlock:2,sleepCallCallBack,pos2
	posBlock:2,wakeUpCallBack,pos2
	posBlock:0,sleepCallCallBack,pos3
	*posBlock:0,updateCallCallBack,pos3
	posBlock:1,sleepCallCallBack,pos4
	*posBlock:1,updateCallCallBack,pos4
	posBlock:2,sleepCallCallBack,pos0
	*posBlock:2,updateCallCallBack,pos0
	posBlock:0,wakeUpCallBack,pos3
	`
...
func TestCaroselloChange2PagesNextFromDown(t *testing.T) {
	...
	*posBlock:2,updateCallCallBack,pos0
	...
	posBlock:1,sleepCallCallBack,pos4
	posBlock:2,sleepCallCallBack,pos0
	posBlock:1,wakeUpCallBack,pos4
	posBlock:0,sleepCallCallBack,pos3
	posBlock:1,sleepCallCallBack,pos4
	posBlock:2,sleepCallCallBack,pos0
	posBlock:2,wakeUpCallBack,pos0
	posBlock:0,sleepCallCallBack,pos1
	*posBlock:0,updateCallCallBack,pos1
	posBlock:1,sleepCallCallBack,pos2
	*posBlock:1,updateCallCallBack,pos2
	posBlock:2,sleepCallCallBack,pos3
	*posBlock:2,updateCallCallBack,pos3
	posBlock:0,wakeUpCallBack,pos1
	`
	if checkresult(*result, exp) == false {
		t.Errorf("expected \n%s\n got\n%s\n", exp, *result)
	}
...
func TestCaroselloChange3PagesNextFromDown(t *testing.T) {
	...
	*posBlock:2,updateCallCallBack,pos3
	...
	posBlock:1,sleepCallCallBack,pos2
	posBlock:2,sleepCallCallBack,pos3
	posBlock:1,wakeUpCallBack,pos2
	posBlock:0,sleepCallCallBack,pos1
	posBlock:1,sleepCallCallBack,pos2
	posBlock:2,sleepCallCallBack,pos3
	posBlock:2,wakeUpCallBack,pos3
	posBlock:0,sleepCallCallBack,pos4
	*posBlock:0,updateCallCallBack,pos4
	posBlock:1,sleepCallCallBack,pos0
	*posBlock:1,updateCallCallBack,pos0
	posBlock:2,sleepCallCallBack,pos1
	*posBlock:2,updateCallCallBack,pos1
	posBlock:0,wakeUpCallBack,pos4
`
	if checkresult(*result, exp) == false {
		t.Errorf("expected \n%s\n got\n%s\n", exp, *result)
	}
